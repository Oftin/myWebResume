        ...
        return (
            <Fragment>
                <div>
                    ...
                    <div className='grid grid-cols-3 place-items-center mt-36 mb-20'>
                        <div className='col-start-1 col-span-3'>
                            ...
                            <a href='https://www.linkedin.com/in/kamil-bobrowski-a8a276193/' target='_blank' rel='noreferrer' className='row-start-3 row-end-3 flex justify-center -mt-18' >
