...
const activeSkillBall = 'bg-blue-400 rounded-full h-5 w-5';
const emptySkillBall = 'bg-gray-200 rounded-full h-5 w-5';
        ...
        return (
            <Fragment>
                <div>
                    ...
                    <div className='py-20 -px-0 md:p-20 ml-4 text-sm md:text-base text-bold'>
                        <div className='grid grid-cols-4 grid-flow-col gap-x-2 gap-y-2 md:gap-4'>
                            <div className='col-start-1 col-end-1 space-y-2 md:space-y-1 mb-20' data-aos='fade' data-aos-offset='400' data-aos-duration='1000' data-aos-delay='1000' >
                            ...
                            <div className='col-start-1 col-end-1 space-y-2 md:space-y-1' data-aos='fade-up' data-aos-offset='350' data-aos-duration='1000' data-aos-delay='1500' >
                            ...
                            <div className='col-start-3 col-end-3 space-y-2 md:space-y-1 ml-4' data-aos='fade-left' data-aos-offset='400' data-aos-duration='1000' data-aos-delay='1500' >
                            ...
                            <div className='col-start-4 col-end-4 space-y-2 pt-1 mt-11' data-aos='fade-left' data-aos-offset='350' data-aos-duration='1000' data-aos-delay='1500' >
                            ...
                            <div className='col-start-3 col-end-3 space-y-2 md:space-y-1 ml-4' data-aos='fade-up-left' data-aos-offset='350' data-aos-duration='1000' data-aos-delay='1500' >
