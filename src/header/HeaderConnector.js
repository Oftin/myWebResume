            ...
            <Fragment>
                <div className='relative font-bold font-serif place-items-center '>
                    ...
                    <div className='absolute z-10 text-2xl bottom-5 left-6 text-coolGray-400'>
                        <h1 className='sm:text-4xl md:text-5xl ld:text-5xl text-yellow-500'>Kamil Bobrowski</h1>
                ...
                <div className='flex place-content-center h-16 sm:m-16 md:m-18 ld:m-20'>
                    <div className='justify-center italic font-normal text-xl'>
                        <div className=''>"{ Data[8].quort }"</div>
                        <div className='flex justify-center sm:mt-2 md:mt-2 ld:mt-2'> - { Data[8].author } </div>
                    </div>
                </div>
            </Fragment>
        )
